...
{ id:'D7-01', module:'M7', type:'nyq-sum', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sum of two cosines.<br>'
     ...
     +'<b>Method.</b> List the spectral lines because the highest line determines the bandwidth. The spectrum has impulses at $\\pm40\\pi$ and $\\pm90\\pi$; use the largest in the sampling theorem condition $\\omega_s>2\\omega_M$.<br>'
  ...
  teach:'Require the frequency list before naming $\\omega_M$. This makes the bandwidth follow from identified spectral content rather than from a guess.' },
...
{ id:'D7-02', module:'M7', type:'nyq-sum', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A product of two cosines.<br>'
     +'<b>Find.</b> The Nyquist rate.<br>'
     +'<b>Method.</b> Use the product-to-sum identity because the written factors are not the frequencies present in their product:$$\\cos A\\cos B=\\tfrac12\\left[\\cos(A+B)+\\cos(A-B)\\right].$$'
  ...
  teach:'Ask for both the frequency-shift argument and the identity. The shifted copies explain why the sum and difference frequencies appear.' },
...
{ id:'D7-03', module:'M7', type:'nyq-sum', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A product of a sine and a cosine.<br>'
     +'<b>Find.</b> The Nyquist rate.<br>'
     +'<b>Method.</b> Reduce the product to a sum because the resulting terms show the frequencies that are present. For this sine–cosine product, the identity produces sine terms.<br>'
  ...
  teach:'Write the identity with $A$ and $B$ before substituting values. This keeps the sign pattern visible during the calculation.' },
...
{ id:'D7-04', module:'M7', type:'nyq-sum', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A band-limited signal plus its square.<br>'
     ...
     +'<b>Method.</b> Expand the square because a non-linear operation can create new frequencies. Use $\\cos^{2}\\theta=\\tfrac12+\\tfrac12\\cos2\\theta$ and the product-to-sum identity, then list every frequency in the full result.<br>'
...
{ id:'D7-05', module:'M7', type:'nyq-band', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sinc-shaped signal, with the unnormalised convention $\\operatorname{sinc}(\\theta)=\\dfrac{\\sin\\theta}{\\theta}$.<br>'
     ...
     +'<b>Method.</b> Use the standard sinc pair because its frequency-domain support gives the bandwidth directly:$$\\frac{\\sin(Wt)}{\\pi t}\\;\\longleftrightarrow\\;\\begin{cases}1,&|\\omega|<W,\\\\0,&|\\omega|>W.\\end{cases}$$'
  ...
  teach:'Draw $X(j\\omega)$ before stating the rate. The rectangle edges then identify the bandwidth and preserve the factor $\\pi$.' },
...
{ id:'D7-06', module:'M7', type:'nyq-band', src:'Final Q4',
  ...
  sol:'<b>Given.</b> The square of a sinc.<br>'
     ...
     +'<b>Method.</b> Use the multiplication property because the signal is squared. Squaring in time is convolution in frequency with the factor $\\tfrac{1}{2\\pi}$. The sinc spectrum is a rectangle, and its self-convolution is a triangle of twice the width.<br>'
  ...
  teach:'Connect this result to the support-addition rule for convolution. The same support calculation applies after the domains are exchanged.' },
...
{ id:'D7-07', module:'M7', type:'nyq-band', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sum of two ideal lowpass signals of different bandwidths.<br>'
     ...
     +'<b>Method.</b> Use linearity because the time signal is a sum. Add the two spectra point by point; because both rectangles are centred at the origin, they overlap rather than sit side by side.<br>'
  ...
  teach:'Compare this question with a product question. For a sum, take the larger support; for a product, add the support half-widths.' },
...
{ id:'D7-08', module:'M7', type:'nyq-band', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sum of a squared sinc and a plain sinc.<br>'
     ...
     +'<b>Method.</b> Treat the terms separately because a sum takes the union of their spectral supports. Find each bandwidth, then use the larger one for the sum.<br>'
  ...
  teach:'State the support rule for a sum before doing arithmetic. The larger support determines the result; the two bandwidths are not added.' },
...
{ id:'D7-09', module:'M7', type:'nyq-op', src:'Final Q4',
  ...
  sol:'<b>Given.</b> Two band-limited signals, convolved.<br>'
     ...
     +'<b>Method.</b> Use multiplication in frequency because the requested operation is convolution in time:$$Y(j\\omega)=X_1(j\\omega)X_2(j\\omega).$$The product is zero wherever either factor is zero.<br>'
  ...
  teach:'Identify one signal as the filter impulse response. Its frequency response then shows directly why only the common band remains.' },
...
{ id:'D7-10', module:'M7', type:'nyq-op', src:'Final Q4',
  ...
  sol:'<b>Given.</b> The same two signals, multiplied instead of convolved.<br>'
     ...
     +'<b>Method.</b> Use convolution in frequency because the requested operation is multiplication in time:$$Z(j\\omega)=\\frac{1}{2\\pi}\\bigl[X_1*X_2\\bigr](j\\omega),$$and add the spectral supports under convolution.<br>'
  ...
  teach:'Compare the product and convolution rules side by side before solving. The operation in time determines whether the spectra are convolved or multiplied.' },
...
{ id:'D7-11', module:'M7', type:'nyq-op', src:'Final Q4',
  ...
  sol:'<b>Given.</b> An ideal lowpass signal modulated by a carrier at $400\\pi$ rad/s.<br>'
     ...
     +'<b>Method.</b> Use modulation because the signal is multiplied by a cosine. Convolution with the cosine’s two impulses produces shifted half-height copies:$$Z(j\\omega)=\\tfrac12X\\bigl(j(\\omega-400\\pi)\\bigr)+\\tfrac12X\\bigl(j(\\omega+400\\pi)\\bigr).$$'
  ...
  teach:'State the centre and half-width of each shifted copy separately. Their outer edge, not the carrier alone, determines $\\omega_M$.' },
...
{ id:'D7-12', module:'M7', type:'nyq-op', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A product of two band-limited signals, and a practical reconstruction filter that cannot cut off instantly.<br>'
     ...
     +'<b>Method.</b> Separate the two tasks because the guard band depends on the bandwidth after multiplication. First find the bandwidth of $w(t)$ by the product rule, then apply the guard-band condition.<br>'
  ...
  teach:'Find the product bandwidth on its own line before applying the guard-band condition. This separates the support calculation from the rate calculation.' },
...
{ id:'D7-13', module:'M7', type:'alias',
  ...
  sol:'<b>Given.</b> A triangular baseband reaching zero at $\\pm50\\pi$ rad/s, sampled every $T=1/300$ s.<br>'
     ...
     +'<b>Method.</b> Read $\\omega_M$ from the spectrum edge because support, not height, sets the required rate. Then use $\\omega_s=2\\pi/T$ and $\\omega_s-2\\omega_M$, and place each unchanged copy at a multiple of $\\omega_s$.<br>'
  ...
  teach:'Mark $\\omega_M$ on the figure before doing arithmetic. Every later rate and guard-band value depends on that edge.' },
...
{ id:'D7-14', module:'M7', type:'alias',
  ...
  sol:'<b>Given.</b> A triangular baseband reaching zero at $\\pm90\\pi$ rad/s, sampled at $\\omega_s=140\\pi$ rad/s.<br>'
     ...
     +'<b>Method.</b> Compare the rate with $2\\omega_M$ because that comparison determines whether adjacent supports meet. If $\\omega_s<2\\omega_M$, find the overlap from the baseband edge and the edge of the copy at $k=1$.<br>'
  ...
  teach:'Mark the two edges $\\omega_s-\\omega_M$ and $\\omega_M$ on the same axis. Their signed separation gives the gap or overlap.' },
...
{ id:'D7-15', module:'M7', type:'alias',
  ...
  sol:'<b>Given.</b> A $450$ Hz cosine sampled at $800$ Hz.<br>'
     ...
     +'<b>Method.</b> Use the distance to a spectral copy because sampling identifies frequencies separated by $f_s$. Fold the component at $f_0$ into $[0,f_s/2]$ by measuring its distance to the nearest multiple of $f_s$.<br>'
  ...
  teach:'Compute the distance to the nearest multiple of $f_s$, not to $f_s/2$. Then verify that the result lies inside $[0,f_s/2]$.' },
...
{ id:'D7-16', module:'M7', type:'alias',
  ...
  sol:'<b>Given.</b> Two cosines, one below and one above $f_s/2$.<br>'
     ...
     +'<b>Method.</b> Fold each frequency to the nearest multiple of $f_s$ because equal folded frequencies produce identical samples. Compare the resulting apparent frequencies before combining the components.<br>'
  ...
  teach:'Write several samples of both components and compare them term by term. Matching values provide a direct check of the alias calculation.' },
...
{ id:'D7-17', module:'M7', type:'recon',
  ...
  sol:'<b>Given.</b> Two non-zero samples of a band-limited signal, and the cutoff choice $\\omega_c=\\pi/T$.<br>'
     ...
     +'<b>Method.</b> Use the interpolation sum because only the stated samples are non-zero. With $\\omega_c=\\pi/T$, simplify the kernel $h_{LP}(t)=\\dfrac{T\\sin(\\omega_ct)}{\\pi t}$ and retain the two non-zero terms in $x_r(t)=\\sum_nx(nT)\\,h_{LP}(t-nT)$.<br>'
  ...
  teach:'Tabulate $h_{LP}(nT)$ at several integers before forming $x_r(t)$. The table shows which interpolation terms contribute at each sample instant.' },
...
{ id:'D7-18', module:'M7', type:'recon',
  ...
  sol:'<b>Given.</b> A zero-order hold, impulse response $h_0(t)=1$ for $0\\le t<T$ and zero elsewhere.<br>'
     ...
     +'<b>Method.</b> Transform the rectangular hold response directly because its integration limits are finite. Then use a limit at $\\omega=0$ and evaluate the magnitude at $\\omega=\\pi/T$.<br>'
  ...
  teach:'Write the small-angle approximation $\\sin x\\approx x$ at $\\omega=0$ before taking the limit. This shows how the removable singularity gives the stated gain.' },
...
{ id:'D7-19', module:'M7', type:'recon',
  ...
  teach:'Ask whether a later filter can separate two contributions already added at one frequency. It cannot, which is why the anti-aliasing filter must come first.' },
...
{ id:'D7-20', module:'M7', type:'recon',
  ...
  sol:'<b>Given.</b> A constant, a cosine, and a sine, sampled exactly at the Nyquist rate of the fastest term.<br>'
     ...
     +'<b>Method.</b> Identify $\\omega_M$ from the largest frequency present, then test the boundary directly because the admissible cutoff interval $\\omega_M<\\omega_c<\\omega_s-\\omega_M$ is empty at the Nyquist rate. Evaluate the sine samples rather than assuming equality is safe.<br>'
  ...
  teach:'List and order every frequency in $x(t)$ before naming $\\omega_M$. The largest present frequency determines the condition.' },
...
{ id:'D7-21', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> Three signals built from the same few ingredients by squaring, modulating and convolving.<br>'
     ...
     +'<b>Method.</b> Transform each operation because the bandwidth must be read from the resulting spectrum. Squaring and multiplying widen the band, while convolution in time multiplies the spectra and can narrow it.<br>'
  ...
  teach:'Compare parts (a) and (c). A time product widens the spectral support by convolution, while a time convolution narrows it by spectral multiplication.' },
...
{ id:'D7-22', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sinc plus a cosine, a product of two cosines, and a product of two sincs.<br>'
     ...
     +'<b>Method.</b> Transform each signal because the written time-domain frequencies do not always equal the final bandwidth. Read $\\omega_M$ from each result and then apply the Nyquist-rate rule.<br>'
  ...
  teach:'Draw the spectrum in part (b) before stating the rate. The impulses at $40\\pi$ and $100\\pi$, with none at $30\\pi$ or $70\\pi$, identify the frequencies created by the product.' },
...
{ id:'D7-23', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sum of two sincs, its modulated version, and the convolution of the two.<br>'
     ...
     +'<b>Method.</b> Find $\\omega_M$ for each operation because the guard-band requirement $\\omega_s\\ge2\\omega_M+\\omega_g$ uses the output bandwidth, not the input bandwidth.<br>'
  ...
  teach:'Before computing part (c), ask whether time convolution can require a wider band than both inputs. Spectral multiplication keeps only their common support, so it cannot.' },
...
{ id:'D7-24', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> Two sinusoids at $100$ Hz and $250$ Hz, sampled at $400$ Hz.<br>'
     ...
     +'<b>Method.</b> Convert all frequencies to hertz so they can be compared with the rate in the same units. A component below $f_s/2$ remains unchanged; one above it folds to $|f-f_s|$.<br>'
  ...
  teach:'Use the sample-value equality as a direct check. Aliased continuous-time signals agree at every sampling instant even though they differ between samples.' },
...
{ id:'D7-25', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A signal band-limited to $1000\\pi$ rad/s, sampled at $1500$ samples per second.<br>'
     ...
     +'<b>Method.</b> Use the sampled-spectrum formula because the question asks for both copy positions and heights. Sampling places copies at multiples of $\\omega_s$ and scales them by $1/T$; then use the Nyquist condition to test whether they remain separate.<br>'
  ...
  teach:'State the permitted values of $\\omega_c$ as an interval. The copy edges determine that interval, while $\\omega_s/2$ is only one possible choice in a symmetric case.' },
...
{ id:'D7-26', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A sampler at $8$ kHz and four input tones.<br>'
     ...
     +'<b>Method.</b> Fold each frequency into $0\\le f\\le f_s/2$ because only that interval contains distinct sampled frequencies. Subtract the nearest multiple of $f_s$ and take the magnitude.<br>'
  ...
  teach:'Ask what a tone at exactly $8$ kHz produces. Its samples are constant, which directly shows why equality does not guarantee recovery.' },
...
{ id:'D7-27', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A squared cosine, a modulated sinc, and a squared sinc.<br>'
     ...
     +'<b>Method.</b> Apply the property that matches each operation because squaring and modulation change support differently. Squaring doubles the band; modulation shifts it without changing its width but can increase $\\omega_M$.<br>'
  ...
  teach:'Parts (a) and (c) apply the same squaring operation. State once that squaring doubles these bandwidths, then apply the rule to both signals.' },
...
{ id:'D7-28', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> A signal sampled comfortably above its Nyquist rate, then decimated by two.<br>'
     ...
     +'<b>Method.</b> Treat decimation as a new sampling operation because discarding every second sample halves the rate. Test the new rate against the unchanged signal bandwidth.<br>'
  ...
  teach:'Write and evaluate the Nyquist condition after decimation. A rate that was sufficient before samples were removed may be insufficient afterward.' },
...
{ id:'D7-29', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> Two band-limited signals combined in three ways.<br>'
     ...
     +'<b>Method.</b> Classify each time-domain operation before computing the rate. A product convolves spectra and adds bandwidths, a sum takes the larger support, and a time convolution multiplies spectra and takes their intersection.<br>'
  ...
  teach:'Write the support rules for a product, sum, and time convolution before solving. Then compare each result with the corresponding rule.' },
...
{ id:'D7-30', module:'M7', type:'full', src:'Final Q4',
  ...
  sol:'<b>Given.</b> An ideal low-pass signal, sampled first above and then below its Nyquist rate.<br>'
     ...
     +'<b>Method.</b> Draw the spectral supports because overlap determines whether a reconstruction filter can isolate the baseband. Place copies at multiples of $\\omega_s$, then inspect their intersections with the filter passband.<br>'
  ...
  teach:'Use the signed quantity $2\\omega_M-\\omega_s$. A negative value gives a guard band; a positive value gives the overlap width and shows that no reconstruction cutoff can isolate the original.' }
