...
{ id:'end-map', module:'Synthesis', nav:'Contributions of each module', title:'Contributions of each module', src:'pp. 2–88',
  ...
  {t:'cols', ratio:'c-6-6', left:[
    ...
    {t:'body', html:`<p>Laboratories A to J let one parameter vary while linked plots and numerical readouts show the result. They cover signal transformations, system properties, convolution, harmonic approximation, filtering, modulation, and sampling.</p>
      <p>Modules 2 to 7 begin with their recurring question types. Every module from 1 to 7 ends with thirty open-ended questions. The last ten are multi-part problems. Work each question on paper before opening its solution, then compare both the calculation and its independent check.</p>`},
    {t:'reveal', at:1, items:[
...
{ id:'end-conventions', module:'Synthesis', nav:'Conventions and symbols', title:'Conventions used throughout', src:'—',
  ...
  {t:'cols', ratio:'c-6-6', left:[
    ...
    {t:'instr', head:'INSTRUCTOR-ONLY · provenance', html:'Artifact v1.8 — Modules 0–7 in 234 scenes, laboratories A–J, and 210 open-ended practice questions, D1–D7, thirty to a module. The contents carries a chapter, section and scene address for every scene, and an anchor into the course textbook for the 208 scenes that have a counterpart there; both are declared once in 89_sections.js and checked by seccheck.js. Modules 2 to 7 open with a taxonomy of the question types that keep coming back; every module closes with the questions themselves, one to a screen. Every number a solution states in its Check step is re-derived independently: 913 checks over the drills, 50 over Modules 1 to 3 and 26 over the Fourier properties of Modules 4 to 6. Source pages 2–88 are mapped scene by scene in the coverage matrix. Confirmed issues in the source material are recorded as A-09 … A-104 in the continuous ledger, and each one is stated in the artifact at the point where it occurs, in the artifact\'s own voice. Coverage matrix, traceability and the ledger are held outside the student build.'}
  ]}
]}
