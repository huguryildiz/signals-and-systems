...
{ id:'end-conventions', module:'Synthesis', nav:'Conventions and symbols', title:'Conventions used throughout', src:'—',
  ...
  {t:'cols', ratio:'c-6-6', left:[
    ...
    {t:'instr', head:'INSTRUCTOR-ONLY · provenance', html:'Artifact v1.3 — Modules 0–7 in 223 scenes, laboratories A–J, and 140 open-ended practice questions, D1–D7, twenty to a module. Each module opens with a taxonomy of the question types that keep coming back and closes with the questions themselves, one to a screen. Every number a solution states in its Check step is re-derived independently: 559 checks over the drills and 50 over the module content. Source pages 2–88 are mapped scene by scene in the coverage matrix. Confirmed issues in the source material are recorded as A-09 … A-104 in the continuous ledger, and each one is stated in the artifact at the point where it occurs, in the artifact\'s own voice. Coverage matrix, traceability and the ledger are held outside the student build.'}
  ]}
]}
