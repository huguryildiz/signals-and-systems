...
{ id:'D6-20', module:'M6', type:'dtft-prop',
  ...
  sol:'<b>Given.</b> The transform of an arbitrary convergent sequence, and two signal generators at frequencies $2\\pi$ apart.<br>'
     ...
     +'<b>Method.</b> Prove periodicity from the analysis definition because the integer time index makes the extra exponential factor equal to one. Substitute $\\omega+2\\pi$ into the sum and simplify that factor.<br>'
