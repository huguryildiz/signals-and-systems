...
{ id:'m0-map', module:'M0', nav:'Course concept map', title:'How the course fits together', src:'pp. 2–88',
  ...
  {t:'cols', ratio:'c-7-5', vcenter:true, left:[
    ...
    {t:'reveal', at:1, items:[
      {t:'note', kind:'ok', head:'What is covered here', html:'Modules 0–3 are complete, together with laboratories A–E and their question banks. Fourier series, the two Fourier transforms and sampling follow in Modules 4–7.'}
    ]}
  ]}
]},
