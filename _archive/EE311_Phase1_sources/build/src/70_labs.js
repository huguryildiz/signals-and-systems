...
const LABS = (() => {
  ...
  /* =======================================================================
     A · SIGNAL TRANSFORMATION LABORATORY            [Source: PDF pp. 3–4]
     y(t) = x(a t − b) built by the source's "shift, then scale" method.
     ======================================================================= */
  const A = (() => {
    /* prototype from PDF p.4: 0 (t<−2); 1 on [−2,0]; 2 on [0,2]; 2→0 linearly on [2,4] */
    const protos = {
      p4: { name:'Source example (PDF p. 4)', sup:[-2,4], yr:[-0.4,2.6],
        ...
        <div class="cols c-7-5" style="gap:44px">
          ...
          <div class="col stack">
            ...
            <div class="note warn"><span class="note-h">Order matters</span>
              ...
              intermediate $v=x(t-b)$ required by the source's <em>shift, then scale</em> method.</div>
          </div></div>`;
  ...
  /* =======================================================================
     B · ENERGY AND POWER CLASSIFIER                 [Source: PDF pp. 2–3]
     ======================================================================= */
  const B = (() => {
    const items = [
    ...
    function draw(root){
      ...
      root.querySelector('.srcref').textContent = '[Source: EE311 Lecture Notes, PDF '+it.src+']';
  ...
  /* =======================================================================
     C · PERIODICITY EXPLORER                        [Source: PDF pp. 5, 8, 10]
  ...
  /* =======================================================================
     D · SYSTEM PROPERTY CHECKER                     [Source: PDF pp. 11–14, 21]
     ======================================================================= */
  const D = (() => {
    let cur=0, open={};
    function draw(root){
      ...
      root.querySelector('.srcref').textContent = '[Source: EE311 Lecture Notes, PDF '+s.src+']';
  ...
  /* =======================================================================
     E · GRAPHICAL CONVOLUTION EXPLORER              [Source: PDF pp. 15–20]
     ======================================================================= */
  const E = (() => {
    const cases = {
      dt1:{ dt:true, name:'x[n]={1,2,1,2}, h[n]={1,1}  (PDF p. 15)', src:'pp. 15–16',
      ...
      dt2:{ dt:true, name:'x[n]=(1/2)ⁿu[n], h[n]=u[n]  (PDF pp. 16–17)', src:'pp. 16–17',
            x:n=>n>=0?Math.pow(.5,n):0, h:n=>n>=0?1:0, kr:[-6,14], nr:[-3,12], yr:[-0.3,2.4],
            exact:'y[n]=\\left(2-\\left(\\tfrac12\\right)^{n}\\right)u[n]' },
      ct1:{ dt:false, name:'x(t)=rect on (0,1), h(t)=t on (0,2)  (PDF pp. 19–20)', src:'pp. 19–20',
            xs:[0,1], hs:[0,2],
      ...
      ct2:{ dt:false, name:'x(t)=e^{2t}u(−t), h(t)=u(t−3)  (PDF pp. 18–19)', src:'pp. 18–19',
            xs:[-20,0], hs:[3,60],
    ...
    function draw(root){
      ...
      const mk=o=>PLOT.Axes(Object.assign({w:760,h:172,xr:c.kr,yr:c.yr,xlabel:c.dt?'k':'τ',
      ...
      root.querySelector('.srcref').textContent='[Source: EE311 Lecture Notes, PDF '+c.src+']';
