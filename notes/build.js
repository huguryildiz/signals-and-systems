...
<script>renderNotes(C1.concat(C23,C4,C5,C6,C7,CA,[{t:'colophon',doc:'Lecture Notes'}]), document.getElementById('doc'), {captions:true}); document.title=document.title;</script>
</body></html>`;
