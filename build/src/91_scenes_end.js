...
{ id:'end-map', module:'Synthesis', nav:'Contributions of each module', title:'Contributions of each module', src:'pp. 2–88',
  ...
  {t:'cols', ratio:'c-6-6', left:[
    ...
    {t:'body', html:`<p>The twelve laboratories, each named after the section it closes, let one parameter vary while linked plots and numerical readouts show the result. They cover signal transformations, even and odd parts, the sifting property of the impulse, system properties, convolution, harmonic approximation, filtering, modulation, and sampling.</p>
...
{ id:'end-conventions', module:'Synthesis', nav:'Conventions and symbols', title:'Conventions used throughout', src:'—',
  ...
  {t:'cols', ratio:'c-6-6', left:[
    ...
    {t:'instr', head:'INSTRUCTOR-ONLY · provenance', html:'Artifact v1.8 — Modules 0–7, twelve laboratories, and 210 open-ended practice questions, D1–D7, thirty to a module. The contents carries a chapter, section and scene address for every scene, and an anchor into the course textbook where a counterpart exists; both are declared once in 89_sections.js and checked by seccheck.js. Every module closes with its questions, one to a screen. Every number a solution states in its Check step is re-derived independently: 913 checks over the drills, 50 over Modules 1 to 3 and 26 over the Fourier properties of Modules 4 to 6. Source pages 2–88 are mapped scene by scene in the coverage matrix. Confirmed issues in the source material are recorded as A-09 … A-104 in the continuous ledger, and each one is stated in the artifact at the point where it occurs, in the artifact\'s own voice. Coverage matrix, traceability and the ledger are held outside the student build.'}
  ]}
]}
