...
{ id:'m6-ex-anun-b', module:'M6', nav:'One-sided exponential · the magnitude', title:'Magnitude of the Transform of $a^{n}u[n]$', src:'pp. 66–67',
  ...
  {t:'cols', ratio:'c-5-7', fill:true, left:[
    {t:'fig', frame:true, grow:true,
      ...
      return a.svg(); },
      caption:'$|X(e^{j\\omega})|$ over three periods. The guide lines are $1/(1-|a|)$ and $1/(1+|a|)$, and the curve touches both in every period.'}
  ], right:[
...
{ id:'m6-ex-lpf', module:'M6', nav:'Worked example · ideal low-pass', title:'Inverse Transform of an Ideal Low-Pass Band', src:'p. 68',
  ...
  {t:'cols', ratio:'c-5-7', fill:true, left:[
    {t:'fig', frame:true, grow:true,
      ...
      const a=AXW(-3*PI,3*PI,PI,{yr:[-0.28,1.72],ylabel:'X(e^{j\\omega})',yticksOverride:[1]});
      a.curve(w=>lpf(w,W),{color:C.in,n:8000});
      markPeriod(a,1.38);
      return a.svg(); },
      caption:'The ideal low-pass spectrum, $1$ on $|\\omega|\\le W$ in each period, drawn over three periods. The band repeats; it does not stop at $\\pm\\pi$.'}
  ], right:[
...
{ id:'m6-ex-pair', module:'M6', nav:'The repeated-pole pair', title:'Repeated-Pole Transform Pair', src:'p. 79',
  ...
  {t:'cols', ratio:'c-5-7', fill:true, left:[
    {t:'fig', frame:true, grow:true,
      ...
      const a=AX({xr:[-3,20],yr:[-0.12*pk,1.3*pk],xlabel:'n',ylabel:'(n+1)a^{n}u[n]',xtarget:8});
      a.stem(s,{color:C.mid,showZero:true});
      return a.svg(); },
      caption:'A repeated factor needs this sequence, $(n+1)a^{n}u[n]$. The factor $n+1$ lifts the early samples; the decay $a^{n}$ wins later. Move $a$.'}
  ], right:[
...
{ id:'m6-projects', module:'M6', nav:'Projects to try', title:'Projects to Try', src:'pp. 64–79',
  ...
  {t:'raw', html:()=>PROJECTS.deck('m6', [
    ...
    {title:'Undoing an echo', glyph:G.echo,
     ...
     look:'The recording comes back exactly. $|H|$ swings between $0.5$ and $1.5$, the inverse between $2/3$ and $2$. Its impulse response $(-0.5)^{n}u[n]$ decays because $|-0.5|<1$.'},
